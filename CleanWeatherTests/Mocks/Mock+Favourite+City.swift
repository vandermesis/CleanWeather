...
extension Mock {
    ...
    static let favouriteity2 = City(id: "CED7073D-B70C-4F25-A5C7-817827112286", name: "New York", latitude: 40.730610, longitude: -73.935242)
    ...
    static let favouriteCities = [city1, city2, city3, city4]
}
